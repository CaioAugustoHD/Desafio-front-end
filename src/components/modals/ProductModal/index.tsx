    ...
    return (
        <div className="modal fade" id="productModal" tabindex="-1" aria-labelledby="productModalLabel" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered modal-xl">
                <div className="modal-content border border-white" style={{boxShadow: "0 3px 8px rgba(0, 0, 0, .08)"}}>

                    <div className="modal-body flex-column flex-lg-row row p-0 align-items-center">
                    <button type="button" className="btn-close position-absolute top-0 end-0 mt-2 me-4" data-bs-dismiss="modal" aria-label="Close"></button>
                        <div className="col-lg-7 m-0 pe-lg-0">
                            <img className="img-fluid rounded-top" src={props.product.image} style={{objectFit: "cover"}} />
                        </div>
                        <div className="col-lg-5 pt-5 px-5">
                            <div className="d-flex px-4 py-2 rounded" style={{ backgroundColor: "#EDEDED", fontSize: "13px" }}>
                                <div className="col-6 d-flex flex-column justify-content-between align-items-start fw-normal" style={{ color: "#696969" }}>
                                    <span className="fs-6 fw-bold" style={{ color: "#515151" }}>{props.product.name}</span>
                                    <span >2 Sabores</span>
