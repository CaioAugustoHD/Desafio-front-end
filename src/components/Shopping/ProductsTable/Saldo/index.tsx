...
export function Saldo() {
  ...
  return (
    <section style={sectionStyle} className="bg-white w-100">
      ...
      <div
        className="bg-white d-flex justify-content-evenly align-items-center"
        style={buttonsContainerStyle}
      >
        <button
          type="button"
          className="btn btn-primary text-white col-4 py-3 border-0 rounded-1"
        ...
        <button
          ...
          className="btn btn-outline-primary col-4 py-3 rounded-1"
        >
